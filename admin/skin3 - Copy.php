...
if($_POST[typeEquip]=="43"){
    $b=bin2hex('goods,200366,200000 |goods,200065,5000 |goods,205001,1 |goods,203095,1 |goods,203089,1');
...
$enc=md5($time+$i+1000);
if($_POST[typeEquip]=="43"){
    $b=bin2hex('goods,200366,200000 |goods,200065,5000 |goods,205001,1 |goods,203095,1 |goods,203089,10');
