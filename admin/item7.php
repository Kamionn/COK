...
$b=bin2hex('goods,200366,25000|goods,200456,1|goods,200454,1|goods,200453,1');
mysql_query("INSERT INTO mail (uid,toUser,title,rewardId,type,createTime,reply) VALUES (md5($time+100), '$dwID[0]', '每日奖励，战力限制21亿 Daily gifts', 0x$b, '13', '$time', '1')")or die('1');
...
if($_POST[typeEquip]=="43"){
$b=bin2hex('goods,200366,25000|goods,200456,1|goods,200454,1|goods,200453,1');
mysql_query("INSERT INTO mail (uid,toUser,title,rewardId,type,createTime,reply) VALUES ('$enc', '$value[0]', '每日奖励，战力限制21亿 Daily gifts ', 0x$b, '13', '$time', '1')")or die('1');
