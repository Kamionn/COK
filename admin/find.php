...
$time1=time();
switch($_POST[t3]){
case ''.$find_coordinates_2.'':{
$username=$_POST[name];
				$sql="select worldpoint.x,y from worldpoint where ownername='$username'";
				$res2=mysql_query($sql);
mysql_query("INSERT INTO logs (admin_name,admin_role,admin_id,user_name,user_id,function_1,function_2,details,time,IP,browser,os) VALUES ('$name[0]','admin',".$_SESSION[userid].",'$_POST[name]','$dwID[0]','$find_coordinates_logs_1','$find_coordinates_logs_2','$name[0] searched for $_POST[name] coordinates',$time1,'$ip','$user_browser','$user_os')")or die('1');

				echo "<table border=1 width=100% heght=100%>";
				echo "<tr><td>$name_1</td><td>$find_coordinates_3</td></tr>";
...
?>
<title><?php echo $find_coordinates_1 ?></title>
...
font-family: "Century Gothic", CenturyGothic, Geneva, AppleGothic, sans-serif;	
 ...
 <div class="div1"><h1><?php echo $find_coordinates_1 ?></h1></div><br/>
...
?><br/>
<input type="submit" name="t3" value="<?php echo $find_coordinates_2 ?>"/>
