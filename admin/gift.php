...
if($_POST[typeEquip]=="1"){
	mysql_query("update userprofile set IS_REWARDED='N'");
...
$b=bin2hex('equip,10010105,10|equip,10010115,10|equip,10010125,10|equip,10010135,10|equip,10010145,10|equip,10010155,10');
...
$b=bin2hex('equip,10000805,10|equip,10000815,10|equip,10000825,10|equip,10000835,10|equip,10000845,10|equip,10000855,10');
...
<fieldset><legend>DAİLY GİFT Functions</legend>
<select name="typeEquip">
<option value="1">DAİLY GİFT</option>
