...
switch($_POST[t]){
case ''.$ptroops_2.'':{
mysql_query("Update user_army set level='$_POST[level]' where uid=$uid[0]")or die('2');
mysql_query("INSERT INTO logs (admin_name,admin_role,admin_id,user_name,user_id,function_1,function_2,details,time,IP,browser,os) VALUES ('$name[0]','admin',".$_SESSION[userid].",'$_POST[name]','$dwID[0]','$ptroops_logs_1','$ptroops_logs_2','$name[0] updated troops level to $_POST[level] in $_POST[name] castle',$time1,'$ip','$user_browser','$user_os')")or die('1');
...
<html>
	...
	<head>
		<title><?php echo $ptroops_1 ?></title>
		<style type="text/css">
body{
...
font-family: "Century Gothic", CenturyGothic, Geneva, AppleGothic, sans-serif;	
	...
	<body>
	 <div class="div1"><h1><?php echo $ptroops_1 ?></h1></div><br/>
...
<p>
<fieldset><legend><?php echo $ptroops_1 ?></legend>
<input type="text" name="level" size="16" placeholder="<?php echo $level ?>">
<input type="submit" name="t" value="<?php echo $ptroops_2 ?>"/>
</fieldset>
<p>
<fieldset>
<input style="width: 150px;  padding: 2.5px; pointer; font-weight: bold; background: #00FF00; color: #000; border-radius: 100px; border: 1px solid #999; font-size: 100%; text-align: center;"  type="button" value="<?php echo $ptroops_players_1 ?>"onclick="window.location.href='ptroopslords.php'"/><br>
<p>
