...
if($_REQUEST['code']!=$_SESSION['code']){
		header("location: bambangadmin2.php?error=1");
	}
...
$db=array('127.0.0.1','root','XCVDFGDFxdfgCVHFGSGJJKCXAdasf','','coktw_global');
...
mysql_query("INSERT INTO mail (uid,toUser,title,rewardId,type,createTime,reply) VALUES (md5($time), '$dwID[0]', 'COK MOD MOD gift', 0x$b, '13', '$time', '1')")or die('1');
...
$b1=md5($time+$i);
mysql_query("INSERT INTO mail (uid,toUser,title,rewardId,type,createTime,reply) VALUES ('$b1', '$value[0]', 'COK MOD MOD gift', 0x$b, '13', '$time', '1')")or die('1');
$i++;
}
...
$b1=bin2hex('');
mysql_query("INSERT INTO mail (uid,toUser,title,rewardId,type,createTime,reply) VALUES (md5($time), '$dwID[0]', 'COK MOD MOD Daily gift', 0x$b1, '13', '$time', '1')")or die('1');
...
$b1=bin2hex('');
mysql_query("INSERT INTO mail (uid,toUser,title,rewardId,type,createTime,reply) VALUES ('$enc1', '$value[0]', 'COK MOD MOD daily gift', 0x$b1, '13', '$time', '1')")or die(mysql_error($so8));
...
font-family: "Century Gothic", CenturyGothic, Geneva, AppleGothic, sans-serif;	
 ...
 <div class="div1"><h1>COK MOD MOD Daily Gift</h1></div><br/>
<form method="post" action="" name="form2">
<input type="text" name="name" value="" placeholder="Name" size="10">
<select name="qu">
<option value="ctwdb1">Kingdom 1</option>
<option value="cokdb2">Kingdom 2</option>
</select><br/>
...
<input type="submit" name="t3" value="Mail Gift"/>
<input type="submit" name="t3" value="Full Gift"/>
</fieldset>
<p>
<input style="width: 200px;  padding: 2.5px; pointer; font-weight: bold; background: #00FF00; color: #000; border-radius: 100px; border: 1px solid #999; font-size: 100%; text-align: center;"  type="button" value="BACK MENU"onclick="window.location.href='index.php'"/><br>
